...
export const Route = createFileRoute("/admin/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Admin overview for the society.",
      },
    ],
  }),
    ...
    <AppShell title="Admin workspace" eyebrow="Admin">
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-4">
        ...
        <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
          ...
          <p className="text-sm text-muted-foreground">
            Full history of actions across the security and resident
            workflows.
          </p>
        ...
        {/* Security Staff */}
        <section className="rounded-xl border border-border bg-card p-5 shadow-sm">
          <SectionHeading title="Security Staff" />

          <p className="text-sm text-muted-foreground">
            Create and manage security staff accounts for your society.
          </p>
